...
const API_URL = 'https://backend.haaka.online/api';
                ...
                {currentMovies.map((movie) => (
                  <MovieCard 
                    ...
                    actions={(
                      <>
                        <button
                          onClick={() => navigate(`/admin-dashboard/new-movie?movieId=${movie._id}`)}
                          className="bg-white/8 border border-white/15 text-white px-4 py-2 rounded-full hover:bg-white/12 transition duration-200 text-sm font-medium"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => navigate(`/admin-dashboard/movie-management/${movie._id}`)}
                          className="bg-yellow-400 text-black px-4 py-2 rounded-full hover:bg-yellow-500 transition duration-200 text-sm font-bold"
                        >
                          Manage
                        </button>
                      </>
